<template>
    <div class="columns">
        ...
        this.tento
              ...
              ">
                  ...
                  Lương cơ bản
                                ...
                                <td rowspan="2"
                                    style="text-align: center; font-size:small; font-weight: bold; width: 8%;">
                                    Lương QLSP
                                </td>
                                <td rowspan="2"
                                    style="text-align: center; font-size:small; font-weight: bold; width: 6%;">
                                    Lương công đoạn
                                </td>
                                <td rowspan="2" style="text-align: center; font-size:small; font-weight: bold;">
                                    Lương phát sinh
        ...
        eFloat(dtl.dongia) | formatNumber
}}
                                            </td>
                                            <td style="font-size: small; text-align: center;">
                                                {{ dtl.stopday_losx }}
                ...
                if (result.isConfirmed) {
                    try {
                        ...
                        if (this.dscongnhan.length <= 0) {
                            ...
                            this.$axios.$delete(`/api/ketoan/delluongthang?thang=${this.thang}&nam=${this.nam}&mapb=${this.maxuong}`);
