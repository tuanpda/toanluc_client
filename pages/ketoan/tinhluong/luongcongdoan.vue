<template>
  <div class="column">
    <div class="box" style="margin-left: 3px; margin-right: 3px">
      ...
      >
        ...
        <tr>
          ...
          >
            <template v-if="mato == ''">
              BẢNG LƯƠNG
              <span style="text-transform: uppercase">{{ this.tenxuong }}</span>
              THÁNG {{ thang }} NĂM {{ nam }}
            </template>
            <template v-else>
              BẢNG LƯƠNG
              <span style="text-transform: uppercase">{{ this.tento }}</span>
              THÁNG {{ thang }} NĂM {{ nam }}
            </template>
          </td>
        </tr>
      ...
      <div class="column is-4" style="margin-top: 1px">
        <div class="table_wrapper">
          <table
            class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth"
          >
            ...
            <section class="modal-card-body">
              <div class="table_wrapper">
                ...
                >
                  ...
                  <tr v-for="(dtl, index) in detailcongnhat" :key="index + 'd'">
                    <td style="font-size: small; text-align: center; width: 5%">
                      {{ index + 1 }}
                    </td>
                    <td style="font-size: small; text-align: center; width: 5%">
