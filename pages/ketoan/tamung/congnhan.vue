      ...
      <div class="box" style="margin-left: 80px; margin-right: 80px;">
        <div class="columns">
          <div class="column">
            <div class="control">
              ...
              <span style="color: #3850b7; font-size: 14px; font-weight: bold;">Quản lý tiền ứng</span>
            </div>
          </div>
        </div>
        ...
        <div class="table_wrapper">
          <table class="
            ...
            <thead>
              <tr>
                <th style="text-align: center; font-size: small; font-weight: bold;">STT</th>
                <th style="text-align: center; font-size: small; font-weight: bold;">Sửa</th>
                <th style="text-align: center; font-size: small; font-weight: bold;">Xóa</th>
                <th style="text-align: center; font-size: small; font-weight: bold;">Người ứng</th>
                <th style="text-align: center; font-size: small; font-weight: bold;">Tiền ứng</th>
                <th style="text-align: center; font-size: small; font-weight: bold;">Ngày ứng</th>
                <th style="text-align: center; font-size: small; font-weight: bold;">Nội dung</th>
                <th style="text-align: center; font-size: small; font-weight: bold;">Phòng ban</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="(ut, index) in data_ung" :key="index">
                <td style="text-align: center; font-size: small;">{{ index + 1 }}</td>
                <td style="text-align: center; font-size: small; font-weight: bold; color: green">
                ...
                <td style="font-size: small; text-align: right;">{{ ut.tienung }}</td>
                <td style="text-align: center; font-size: small;">{{ (ut.ngayung) | formatDate }}</td>
                  ...
                  <div class="table_wrapper">
                    <table class="table is-responsive is-bordered is-narrow is-fullwidth">
                      <tr style="background-color: #fef2ec">
                        <td colspan="2" style="text-align: left; font-size: small; font-weight: bold; color: #485fc7;">
                          <div class="control">
                            <label class="radio">
                              <input type="radio" v-model="isNhanvienorCongnhan" value="vanphong" name="answer" />
                              Văn phòng
                            </label>
                            <label class="radio">
                              <input type="radio" v-model="isNhanvienorCongnhan" value="phanxuong" name="answer" />
                              Phân xưởng
                            </label>
                          </div>
                        </td>
                      ...
                      <template v-if="isNhanvienorCongnhan == phanxuong">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="control has-icons-left">
                              <div class="select is-small is-fullwidth">
                                <select @change="calung($event)" v-model="form.manv">
                                  <option selected>-- Chọn công nhân --</option>
                                  <option v-for="item in ds_congnhan" :value="item.macn">
                                    {{ item.tencn }}
                                  </option>
                                </select>
                              </div>
                              <span class="icon is-small is-left">
                                <i style="color: #48c78e" class="far fa-address-card"></i>
                              </span>
                            </div>
                          </td>
                        </tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <input @blur="$v.form.tienung.$touch()" v-model="form.tienung" class="input is-small"
                            type="text" v-mask="mask" placeholder="Nhập tiền ứng" />
                          <div v-if="$v.form.tienung.$error" class="form-error">
                            <span v-if="!$v.form.tienung.required" class="help is-danger">Yêu cầu nhập tiền ứng</span>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <input v-model="form.ngayung" class="input is-small" type="date" />
                          <div v-if="$v.form.ngayung.$error" class="form-error">
                            <span v-if="!$v.form.ngayung.required" class="help is-danger">Yêu cầu nhập ngày ứng
                              tiền</span>
                          </div>
                        </td>
                      </tr>
                        ...
                        <td colspan="2">
                          <div class="control">
                            <label class="radio">
                              ...
                              <span style="font-size: small; font-weight: bold;">Ứng tiền lương</span>
                            </label>
                            <label class="radio">
                              <input type="radio" v-model="form.typeung" value="ungkhac" name="answer" />
                              <span style="font-size: small; font-weight: bold;">Ứng tiền khác</span>
                            </label>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <textarea v-model="form.noidung" @blur="$v.form.noidung.$touch()" class="textarea is-small"
                            placeholder="Nhập vào lý do ứng tiền"></textarea>
                          <div v-if="$v.form.noidung.$error" class="form-error">
                            <span v-if="!$v.form.noidung.required" class="help is-danger">Yêu cầu nhập nội dung ứng
                              tiền</span>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <button @click.prevent="onTaophieuung()" :disabled="$v.form.$invalid"
              ...
              <section class="modal-card-body">
                <table class="table is-responsive is-bordered is-narrow is-fullwidth">
                  ...
                  <tr>
                    ...
                    <td>
                      <multiselect v-model="dm_nhanvien" :options="ds_congnhan" :custom-label="nameWithNhanvien"
                        placeholder="Chọn người ứng" label="maphong" track-by="maphong"
                  ...
                  <tr>
                    <td>Số tiền ứng</td>
                    <td>
                      <input @blur="$v.form.tienung.$touch()" v-model="form.tienung" class="input is-small" type="text"
                        v-mask="mask" placeholder="Nhập tiền ứng" />
                      <div v-if="$v.form.tienung.$error" class="form-error">
                        <span v-if="!$v.form.tienung.required" class="help is-danger">Yêu cầu nhập tiền ứng</span>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <input v-model="form.ngayung" class="input is-small" type="date" />
                      <div v-if="$v.form.ngayung.$error" class="form-error">
                        <span v-if="!$v.form.ngayung.required" class="help is-danger">Yêu cầu nhập ngày ứng tiền</span>
                      </div>
                    </td>
                  </tr>
                  <tr>
                ...
                <div class="columns">
                  <div class="column">
                    <button @click.prevent="[getinfonv(), onTaophieuung()]" :disabled="$v.form.$invalid"
                      class="button is-success is-fullwidth is-small">
                      Xác nhận lập phiếu ứng
                    </button>
                  </div>
