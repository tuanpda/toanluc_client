<template>
    <div class="container">
        <div class="columns" style="margin-top: 10px;">
            <div class="column is-10">
                <div class="file is-small is-info has-name">
                    <label class="file-label">
                        <input ref="fileInput" @change="onFileChange" class="file-input" type="file" name="resume"
            ...
            <div class="column">
                <button @click="onClickImport" class="button is-success is-small" style="width: 100%">
            ...
            <table class="table
                ...
                <thead>
                    <tr style="background-color: #fffaeb;">
                        ...
                        <th style="text-align: center; font-size: small; width: 7%;">Mùa vụ P3</th>
                        <th style="text-align: center; font-size: small; width: 10%;">Thời gian bắt đầu</th>
                        <th style="text-align: center; font-size: small; width: 10%;">Thời gian kết thúc</th>
                        <th style="text-align: center; font-size: small; width: 15%;">Tên khách hàng</th>
                ...
                <tbody>
                    <tr v-for="(excel, index) in dataPreview" :key="index">
                        ...
                        <td style="text-align: right; font-size: small;"><input class="input is-small" type="text"
                                v-model="excel.soluongmuavup1"></td>
                        <td style="text-align: right; font-size: small;"><input class="input is-small" type="text"
                                v-model="excel.soluongmuavup2"></td>
                        <td style="text-align: right; font-size: small;"><input class="input is-small" type="text"
                                v-model="excel.soluongmuavup3"></td>
