                ...
                <div class="table_wrapper">
                    <table class="table is-responsive is-bordered is-narrow is-fullwidth">
                        <tr style="background-color: #f4f2f8">
                            ...
                            <td @click="sort('tensp')"
                                style="font-size: small; text-align: center; font-weight: 600; width: 7%">Tên SP
                            </td>
                            ...
                            <td @click="sort('ngayktkhpx')"
                                style="font-size: small; text-align: center; font-weight: 600; width: 5%;">Tổng ngày
                            </td>
                            <td @click="sort('soluongkhpx')"
                                style="font-size: small; text-align: center; font-weight: 600; width: 7%;">Số lượng
                            </td>
                            <td @click="sort('congsuat')"
                                style="font-size: small; text-align: center; font-weight: 600; width: 6%;">Công suất
                            </td>
                            <td @click="sort('songay')"
                                style="font-size: small; text-align: center; font-weight: 600; width: 5%;">Thời
                                gian(tuần)
                            </td>
                            <td @click="sort('may')"
                                style="font-size: small; text-align: center; font-weight: 600; width: 10%;">Máy
                            </td>
                        ...
                        <tr v-for="(item, index) in sortedsllosx" :key="index + 'llllkiq'">
                            ...
                            <td style="font-size: small; background-color: #effaf5; text-align: center;">{{
                                Math.floor((Date.parse(item.ngayktkhpx) - Date.parse(item.ngaybdkhpx)) / 86400000)
                            }}
                            </td>
                            <td style="font-size: small; text-align: center; background-color: #effaf5;">{{
                                item.soluongkhpx | formatNumber
                            }}</td>
                            <td style="font-size: small; text-align: center; background-color: #effaf5;"><input
                                    type="text" v-model.trim="item.congsuat" class="input is-small"></td>
                            <td style="font-size: small; text-align: right; background-color: #effaf5;">{{
                                // Math.round((parseFloat(item.soluongkhpx) / parseFloat(item.congsuat) * 100) / 100)
                                parseFloat(item.soluongkhpx) / parseFloat(item.congsuat)
                            }}
                            </td>
                            <td style="font-size: small; text-align: center; background-color: #effaf5;">
                                <div class="select is-small is-fullwidth">
                                    <select v-model="item.may">
                                        <option selected>{{ item.may }}</option>
                                        <option value="Máy 01">Máy 01</option>
                                        <option value="Máy 02">Máy 02</option>
                                        <option value="Máy 03">Máy 03</option>
                                    </select>
                                </div>
                            </td>
